...
# YYYY-MM-DD
# Every month and every day statistics
...
plt.title('The metrics below are in billions of dollars');
plt.xticks(middle_x, quarter_labels)

plt.savefig("Step_7.png")
...
plt.bar(range(1,13),netflix_stocks['Price'])
...
plt.bar(range(1,13), dowjones_stocks['Price'])

ax2.set_title('Dow Jones')
ax2.set_xlabel('Date')
ax2.set_ylabel('Stock Price')
plt.subplots_adjust(wspace=.5)
#plt.savefig("dowjones.png")
plt.show()
